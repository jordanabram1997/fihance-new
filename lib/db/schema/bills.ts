...
import { char, date, index, integer, numeric, pgEnum, pgTable, text, timestamp, uuid, varchar } from "drizzle-orm/pg-core";
...
export const bills = pgTable("bills", {
    ...
    index("bills_assigned_user_idx").on(table.assignedUserId),
